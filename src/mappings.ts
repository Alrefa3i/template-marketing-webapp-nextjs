...
export const componentMap = {
  ...
  ComponentCarouselVideo: dynamic(() =>
    import(
      '@src/components/features/ctf-components/ctf-carousel-video-component/ctf-carousel-video-component'
    ).then(module => module.CtfCarouselVideoComponent),
  ),
};
...
export const componentGqlMap = {
  ...
  ComponentCarouselVideo: dynamic(() =>
    import(
      '@src/components/features/ctf-components/ctf-carousel-video-component/ctf-carousel-video-component-gql'
    ).then(module => module.CtfCarouselVideoComponentGql),
  ),
};
